...
func main() {
	...
	flag.BoolVar(&copilotLogin, "copilot-login", false, "Login to GitHub Copilot subscription using OAuth or local credentials")
	...
	} else if copilotLogin || copilotBrowserLogin {
